...
void InitDefaultAIRelationships()
{
	...
	// ------------------------------------------------------------
		...
		CCombatCharacter::SetDefaultRelationship(CLASS_HOUNDEYE,			CLASS_STALKER,			D_HT, 0);		
		...
		CCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_HOUNDEYE,			D_HT, 0);
