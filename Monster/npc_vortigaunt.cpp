...
LINK_ENTITY_TO_CUSTOM_CLASS( npc_vortigaunt, cycler_actor, CNPC_Vortigaunt );
...
public:
	...
	void Precache() override
	{
		...
		PrecacheModel( "models/ep2/vortigaunt_slave.mdl" );
		SetModel( "models/ep2/vortigaunt_slave.mdl" );
	}
